...
Teto por arquivo: 350 linhas. Arquivos: 58.

## raiz do projeto

```
app.py                          275  sobe o FastAPI, a porta de acesso e as rotas de busca e ajuste
config.py                        74  caminhos do projeto e leitura das configuracoes, com volume de dados na VPS
...
rotas/disparo.py                302  disparo: fila, envio da mensagem, iniciar e pausar o motor
rotas/disparo_evolution.py       84  instancias da Evolution: qrcode, estado do chip e o numero pareado
rotas/modelos.py                158  os contratos de entrada da API, num lugar so
...
scrapers/disparo_fila.py        254  a fila do disparo em SQLite, o bloqueio de telefone e o anti-duplicata
...
web/js/analise.js               299  analise do lead por IA: score, estrategia, referencia e Instagram
web/js/busca.js                 306  busca de negocios, filtro dos resultados e exportacao
...
web/js/crm_cartao.js            267  cartao do lead, acao em massa e KPIs do CRM
web/js/detalhe.js               144  modal de detalhe do lead, screenshot e extracao de contato
web/js/disparo.js               310  disparo automatico: fila, migracao, envio e status
web/js/tabela.js                257  tabela de resultados: ordenacao, selecao, paginacao e acoes em lote
web/js/ui.js                    114  estado compartilhado do painel e as pecas visuais reusadas
```
