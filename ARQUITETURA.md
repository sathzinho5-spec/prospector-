...
```
app.py                           285  sobe o FastAPI, a porta de acesso e as rotas de busca e ajuste
...
rotas/disparo.py                 311  disparo: fila, envio da mensagem, cadencia, iniciar e pausar o motor
...
rotas/modelos.py                 204  os contratos de entrada da API, num lugar so
...
scrapers/disparo.py              308  o motor do disparo: janela de horario, worker em thread, iniciar e pausar
scrapers/disparo_abordagens.py   189  o que saiu por lead e a conversa iniciada, fora do alcance da limpeza
scrapers/disparo_cadencia.py     158  o ritmo do disparo derivado da janela de horario e do limite do dia
...
scrapers/disparo_fila.py         214  a fila do disparo em SQLite, o bloqueio de telefone e o anti-duplicata
...
web/js/disparo_aba.js            277  aba Disparo: os KPIs, a cadencia mostrada e a lista de leads
