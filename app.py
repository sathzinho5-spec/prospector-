...
async def api_search(req: SearchRequest):
    ...
    try:
        termos = niches.variacoes_para(req.query.strip()) if req.usar_variacoes else [req.query.strip()]
...
@app.post("/api/instagram/prospectar")
...
@app.post("/api/instagram/dos-sites")
